...
#### [Retrieving Models](https://yuga-framework.gitbook.io/documentation/database/elegant#retrieving-models) <a href="#markdown-header-retrieving-models" id="markdown-header-retrieving-models"></a>
